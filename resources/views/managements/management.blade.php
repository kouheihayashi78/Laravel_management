...
@foreach($messages as $message)
    <a href="/edit/{{ $message['id'] }}" placeholder="入力して下さい">{{ $message['message'] }}</a>
    <a href="/edit/{{ $message['id'] }}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
